      ...
      <main className="container mx-auto p-4 flex-grow">
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mt-6 bg-card rounded-xl shadow-lg p-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 bg-primary  font-bold text-primary-foreground rounded-xl hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
