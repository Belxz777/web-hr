 ...
 {loading ? (
    <>
      ...
      Отправка...
               ...
               : (
                 <div className="flex flex-col items-center justify-center bg-gray-800 rounded-xl p-6 max-w-2xl mx-auto mt-4">
                   <h1 className="text-2xl font-bold text-gray-300 mt-4 ">Задач для отчета нет </h1>
                 <button className='flex flex-row text-xl font-bold text-gray-300 mt-4 text-center'
                 onClick={()=>{
                   router.back(
