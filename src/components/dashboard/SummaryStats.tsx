    ...
    <div className="mb-8">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm mb-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-[#FF0000] to-[#cc0000] rounded-xl p-4 text-center text-white">
            <div className="flex items-center justify-center mb-2">
              <svg
                className="w-6 h-6 mr-2"
                fill="none"
              ...
              <h4 className="text-sm font-semibold">Часы на поручения</h4>
            </div>
          ...
          <div className="bg-gradient-to-br from-[#FF0000] to-[#cc0000] rounded-xl p-4 text-center text-white">
            <div className="flex items-center justify-center mb-2">
              ...
              <h4 className="text-sm font-semibold">Сотрудников</h4>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <div className="w-4 h-4 bg-[#249BA2] rounded-sm"></div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#000000]">
                  Поручения: <span className="font-semibold">{convertedDeputyHours}</span> (
                  {totalStats.total_hours > 0
